...
public class CorruptionMod {
    ...
    public CorruptionMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = CorruptionMod.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
