...
import com.gabriberp.corruption.Entity.Client.Model.*;
...
public class ModEventBusEvents {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(CorruptionBugModel.LAYER_LOCATION, CorruptionBugModel::createBodyLayer);
    }
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.CORRUPTION_BUG.get(), CorruptionBugEntity.createAttributes().build());
    }
}
